define([
    ...
    function (declare, array, query, domAttr, domStyle, on, lang, CheckBox, _BaseWidget, commonConfig, _WidgetsInTemplateMixin, template) {
        ...
        return declare([_BaseWidget, _WidgetsInTemplateMixin], {
            ...
            setResources: function () {
                this.mapUrls = commonConfig.mapUrls;
